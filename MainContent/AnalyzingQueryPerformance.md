...
인덱스 사용 분석에 덧붙여 옵티마이저가 결정하는 조인 전략의 효율성을 조사해야만 한다. SQL Server는 4가지 종류의 조인이 있다.
  ...
  * 적응형 조인
  ...
  - 병합 조인(Merge Join)  
    ...
    <img src = "image/09/09_09_ExePlanWithMergeJoin.png">       
    ...
    <img src = "image/09/09_10_PropertiesCLIndexScanShowingDataOrderd.png">       
  ...
  - 중첩 루프 조인(Nested Loop Join)      
    ...
    <img src = "image/09/09_11_ExePlanNestedLoopJoin.png">       
