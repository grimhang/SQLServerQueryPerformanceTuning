...
이번 장에서는 많은 양의 부하를 발생시키는 쿼리들을 식별하기 위한 방법으로 확장이벤트를 설명했다. 확장이벤트 세션을 만들고 수집하는 절차는 시스템 저장 프로시저를 사용해 자동화 하는것이 좋다. 실행중인 쿼리에 대한 통계에 즉각적인 접근하기 위해 DMV sys.dm_exec_query_stats를 사용해라
