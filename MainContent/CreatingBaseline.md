...
## <font color='dodgerblue'>7.1 가상 또는 실제 머신을 모니터링 할때 고려사항</font>
...
## <font color="dodgerblue">7.2 Baseline 생성</font>
...
## <font color="dodgerblue">7.3 Baseline 데이터를 바탕으로 시스템 활동 분석</font>
...
## <font color="dodgerblue">7.4 Azure SQL Database의 베이스라인</font>
...
## <font color="dodgerblue">7.5 요약</font>
